    ...
    <div class="mod-config">
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <i class="el-icon-time"></i>
            <span style="margin-left: 10px">{{ formatDate(scope.row.retreatTime)}}</span>
          </template>
        </el-table-column>
        <el-table-column
          prop="retreatType"
...
<script>
  import AddOrUpdate from './retreat-add-or-update'
  ...
  export default {
    ...
    methods: {
      ...
      getDataList() {
        ...
        this.$http({
          url: this.$http.adornUrl('/generator/retreat/list'),
          method: 'get',
      ...
      deleteHandle(id) {
        ...
        this.$confirm(`确定对[id=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/generator/retreat/delete'),
            method: 'post',
